/* ========================================================================
   ...
   $Date: $
   $Revision: $
   $Creator: Mehmet SARIHAN $
   ======================================================================== */

/*
  TODO(mehmet):  THIS IS NOT A FINAL PLATFORM LAYER!!!
    ...
    if(FileHandle != INVALID_HANDLE_VALUE)
    {
        ...
        if(GetFileSizeEx(FileHandle, &FileSize))
        {
            ...
            if(Result.Contents)
            {
                ...
                {
                    // NOTE(mehmet): File read successfully
...
Win32LoadGameCode(char *SourceDLLName, char *TempDLLName)
{
    ...
    // TODO(mehmet): Need to get the proper path here!
    // TODO(mehmet): Automatic determination of when updates are necessary.
...
{
  //TODO(mehmet): Dest bounds checking!
        ...
        int ShowCode)
{
  ...
  //NOTE(mehmet): Never use MAX_PATH in code that is user-facing, because it
  ...
  char SourceGameCodeDLLFilename[] = "neshteo.dll";
  char SourceGameCodeDLLFullPath[MAX_PATH];
  CatStrings(OnePastLastSlash - EXEFileName, EXEFileName,
             sizeof(SourceGameCodeDLLFilename) - 1, SourceGameCodeDLLFilename,
             sizeof(SourceGameCodeDLLFullPath), SourceGameCodeDLLFullPath);

  char TempGameCodeDLLFilename[] = "neshteo_temp.dll";
  ...
  CatStrings(OnePastLastSlash - EXEFileName, EXEFileName,
    ...
    // NOTE(mehmet): Set the Windows scheduler granularity to 1ms
...
//    WindowClass.hIcon;
    WindowClass.lpszClassName = "NeshteoHeroWindowClass";

    // TODO(mehmet): How do we reliably query on this on Windows?
...
#define GameUpdateHz (MonitorRefreshHz / 2)
    ...
    if(RegisterClassA(&WindowClass))
    {
        ...
        if(Window)
        {
            ...
            // On the Neshteo Hero machine, it was 480 samples.
            while(GlobalRunning)
            {
                DWORD PlayCursor;
                DWORD WriteCursor;
            ...
            if(Samples && GameMemory.PermanentStorage && GameMemory.TransientStorage)
            {
                ...
                while(GlobalRunning)
                {
                  ...
                  if(CompareFileTime(&NewDLLWriteTime, &Game.DLLLastWriteTime) != 0)
                    ...
                    // TODO(mehmet): Zeroing macro
                    // TODO(mehmet): We can't zero everything because the up/down state will
                    // be wrong!!!
                    ...
                    *NewKeyboardController = {};
                    ...
                    if(!GlobalPause)
                    {
                        // TODO(mehmet): Need to not poll disconnected controllers to avoid
                        ...
                        // TODO(mehmet): NOT TESTED YET!  PROBABLY BUGGY!!!!!
                        ...
                        {                        
                            ...
                            {
                                // TODO(mehmet): LOG MISSED SLEEP HERE
                            }
                        ...
                        win32_window_dimension Dimension = Win32GetWindowDimension(Window);
#if NESHTEO_INTERNAL
                        // TODO(mehmet): Note, current is wrong on the zero'th index
                        ...
                        NewInput = OldInput;
                        OldInput = Temp;
                        // TODO(mehmet): Should I clear these here?
